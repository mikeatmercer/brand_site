...
export default function () {
    ...
    let scrollSections = [];
    scrollSections["navBar"] = useRef(null)
    ...
    let cardSections = liveSections.map((e,i) =>{
        ...
        switch(type) {
            case "Hero":
                chi =  <Hero mod={e}  alert={(alert && i === 0)? alert : null} clickScroll={clickScroll} />
                break;
            case "Overview":
                chi = <Overview mod={e} order={i} scroller={scroller} clickScroll={clickScroll} />
                break; 
            case "Cards":
                chi = <CardSection mod={e} order={i} clickScroll={clickScroll} />
                break;
            case "SummaryText":
                chi = <TopText mod={e} allMods={mods} order={i} clickScroll={clickScroll} />
                break;
            case "AccordionHeader":
                chi = <Accordion mod={e} order={i} allMods={mods} clickScroll={clickScroll} /> 
                break;
            case "PageCopy" : 
                chi = <PageCopy mod={e} />
        }
